  ...
  */
  ...
  it.describe('', () =>{
    it('Fill all filfs', async ({page}) =>{
        ...
        await page.getByPlaceholder('Address 1').fill('04 Tobie Ct')
        await page.getByRole('textbox', {name:"Zip code"}).fill('1')
    })
  })
